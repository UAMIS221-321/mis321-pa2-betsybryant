...
namespace mis321_pa2_betsybryant
{
    class Program
    {
        ...
        {
            int playerChoice = Menu.BeginGame();
        ...
        static void P1Menu() 
        {
            ...
            int pickPlayer = Menu.Player1Menu();
            while(pickPlayer != 4)
            {
        ...
        static void P2Menu(Character player1) 
        {
            ...
            int pickPlayer2 = Menu.Player2Menu();
            while(pickPlayer2 != 4)
            {
        ...
        static void WhoGoesFirst(Character player1, Character player2)
        {
            ...
            if(number == 1)
            {
                Console.WriteLine($"{player1.CharacterName}/ {player1.PlayerName} will go first");
                System.Threading.Thread.Sleep(1000);
            ...
            {
                Console.WriteLine($"{player2.CharacterName}/ {player2.PlayerName} will go first");
                System.Threading.Thread.Sleep(1000);
                while(player1.Health >= 0 && player2.Health >= 0)
                {
                    Game2(player1, player2);
